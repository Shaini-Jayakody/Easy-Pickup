    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to cancel booking <strong id="cancel-ref-no"></strong>?</p>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="confirm-cancel-btn">
                    <span id="cancel-text">Yes, Cancel Booking</span>
                    <span id="cancel-spinner" style="display:none;">
